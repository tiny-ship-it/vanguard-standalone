/**
 * Vanguard Pulsar
 * Integrates behavioral pulse signals into Vanguard routing and behavior.
 */
...
const HEART_DB_PATH = process.env.VANGUARD_HEART_DB || path.join(__dirname, '../../data/heart-signals.db');
const DUNBAR_DB_PATH = process.env.VANGUARD_DUNBAR_DB || path.join(__dirname, '../../data/dunbar-signals.db');
